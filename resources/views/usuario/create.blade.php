                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="activo">
                                            ...
                                            <option {{ old('activo') == 'Si' ? 'selected' : '' }} value="Si">
                                                Si</option>
                                            <option {{ old('activo') == 'No' ? 'selected' : '' }} value="No">
                                                No</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="rol">
                                            <option value=" " selected>Seleccionar...</option>
                                            <option {{ old('rol') == 'Administrador' ? 'selected' : '' }} value="Administrador">
                                                Administrador</option>
                                            <option {{ old('rol') == 'Personal' ? 'selected' : '' }} value="Personal">
                                                Personal</option>
                                        </select>
                                    </div>
                                </div>
